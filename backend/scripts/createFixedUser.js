...
const createFixedUser = async () => {
  try {
    // Create test user data
    const userData = {
      // General Section
      name: "Sydney Sanders",
      email: "ssanderss444@gmail.com",
    ...
    console.log('Fixed test user created successfully:', user);

  } catch (error) {
    console.error('Error creating fixed test user:', error);
  } finally {
